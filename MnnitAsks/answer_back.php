...
{
    $answer = $_POST['answerArea'];  // Main question here got through ajax post.// Question Description.
...
<?php
    ...
    {
        $insertionQuery = "INSERT into answers VALUES('','$qid','$uid','$answer','','','$ip','$time')";
