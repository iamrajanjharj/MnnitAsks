 ...
 */
    ...
    if(isset($_POST['email']))
    {
        ...
        {
            $query_insertion = mysqli_query($con,"INSERT INTO users VALUES('', '$name','$username','$email','$p','$yearofcourse','$branch','$contact','$hostel','$ip','$time','$date_of_creation')") or die(mysqli_error($con));
