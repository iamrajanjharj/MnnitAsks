...
<div id="menuHolder" style="top:118px;">
<ul>
...
if(isset($_SESSION['email']))
{
    echo '<li id="following"><img src="user.png" alt="Top" width="20" /><a href="account.php?username='.$_SESSION['username'].'" style="color: grey;" class="none"> &nbsp;Account</a>';
}
...
echo '<div style="border:1px dashed #000000;text-align: center;padding: 10px;background: #b10f2e;color: white;">
        ...
        <h5>
            ...
            <span style="color: white;">Hostel: </span><span> '.$hostel.'</span>
        </h5>
     </div>';
     ...
     <div id="f">
         ...
         <li id="following" class="selectedMenu"><img src="follow.png" alt="Top" width="17" /><a href="account.php?username='.$username.'" style="color: grey;" class="none"> Following</a>
         <li id="answers"><img src="answer.png" alt="Featured" width="20" /><a href="account_answers.php?username='.$username.'" style="color: grey;" class="none">Answers</a>
...
$questionq = "SELECT count(*) FROM questions_followers WHERE uid='$accountuid'";
$questionq2 = mysqli_query($con,$questionq) or die(mysqli_error($con));
$questionq3 = mysqli_fetch_row($questionq2) or die(msyqli_error($con));

if($questionq3[0] == 0)
{
    echo '<center><h5>Not Following Any Questions.</h5></center>';
}
else
{
    $questionq = "SELECT * FROM questions_followers WHERE uid='$accountuid'";
    $questionq2 = mysqli_query($con,$questionq) or die(mysqli_error($con));
...
<div id="tagsContainer" style="top:120px;">
