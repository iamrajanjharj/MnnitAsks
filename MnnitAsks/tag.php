...
$questionq = "SELECT count(*) from question_tags WHERE tagid='$tagid'";
...
$questionq = "SELECT * from question_tags WHERE tagid='$tagid'";
$questionq2 = mysqli_query($con,$questionq) or die(mysqli_error($con));
...
for($d=0;$d<$questionq3[0];$d++)
{
    ...
    $questionq99 = "SELECT * from questions WHERE qid='$qid'";
    $questionq100 = mysqli_query($con,$questionq99) or die(mysqli_error($con));
    $questionq101 = mysqli_fetch_assoc($questionq100) or die(mysqli_error($con));
    $question = $questionq101['question'];
    $quesdesc = $questionq101['quesdesc'];
    $time = $questionq101['ques_timestamp'];
    $upvotes = $questionq101['upvotes'];
    $downvotes = $questionq101['downvotes'];
    $views = $questionq101['views'];
    $uuid = $questionq101['uid'];

    $secondone = "select name from users where uid='$uuid'";
