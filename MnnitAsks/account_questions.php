...
echo '<div style="border:1px dashed #000000;text-align: center;padding: 10px;background: #b10f2e;color: white;">
     ...
     <div id="f">
         ...
         <li id="questions" class="selectedMenu"><img src="question.png" alt="Featured" width="20" /><a href="account_questions.php?username='.$username.'" style="color: grey;" class="none">Questions</a>
          </ul>
     </div>
 <hr>';
 

$questionq = "SELECT count(*) FROM questions WHERE uid='$accountuid'";
$questionq2 = mysqli_query($con,$questionq) or die(mysqli_error($con));
$questionq3 = mysqli_fetch_row($questionq2) or die(msyqli_error($con));

if($questionq3[0] == 0)
{
    echo '<center><h5>Not Asked Any Questions.</h5></center>';
}
else
{
    $questionq = "SELECT * FROM questions WHERE uid='$accountuid'";
    $questionq2 = mysqli_query($con,$questionq) or die(mysqli_error($con));
