...
<div class="form-group" id="contactHolder">
    ...
    <input type="text" class="form-control" id="contactNumber" aria-describedby="contactHelp" min="1000000000" placeholder="Enter your contact number here" name="contactNumber" required />
...
<div id="menuHolder">
<ul>
<li id="top" class="selectedMenu"><img src="top.png" alt="Top" width="17" /> &nbsp;&nbsp;Questions
...
$questionq = "SELECT * from questions ORDER BY views DESC";
...
for($d=0;$d<$questionq3;$d++)
{
    ...
    $secondone = "select name,username from users where uid='$uid'";
    ...
    $username = $secondone3['username'];

    echo '<div class="q"><a href="question_browse.php?qid='.$qid.'">'.$question.'</a><hr>
    <span style="color: grey;font-size: 90%;">Asked by: </span><span style="font-size: 90%;"><a href="account.php?username='.$username.'">'.$nameof.'</a> | </span>
